...
class MozButtonMenuButtonBase extends MozBasetext {
  constructor() {
    super();
...
MozXULElement.implementCustomInterface(MozButtonMenuButtonBase, [Ci.nsIDOMXULButtonElement]);
customElements.define("button-menu-button-base", MozButtonMenuButtonBase);
