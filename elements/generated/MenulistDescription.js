  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <xul:hbox class="menulist-label-box" flex="1">
        ...
        <xul:label class="menulist-label" inherits="value=label,crop,accesskey" crop="right" flex="1"></xul:label>
        <xul:label class="menulist-label menulist-description" inherits="value=description" crop="right" flex="10000"></xul:label>
      </xul:hbox>
