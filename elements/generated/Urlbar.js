  ...
  connectedCallback() {
    ...
    this.appendChild(MozXULElement.parseXULToFragment(`
      ...
      <moz-input-box anonid="moz-input-box" tooltip="aHTMLTooltip" class="urlbar-input-box" flex="1">
        ...
        <html:input anonid="input" class="urlbar-input textbox-input" aria-owns="urlbarView-results" aria-controls="urlbarView-results" aria-autocomplete="both" allowevents="true" inputmode="mozAwesomebar" inherits="value,maxlength,disabled,size,readonly,placeholder,tabindex,accesskey,focused,textoverflow"></html:input>
      </moz-input-box>
      ...
      <image anonid="historydropmarker" class="urlbar-history-dropmarker urlbar-icon chromeclass-toolbar-additional" tooltiptext="FROM-DTD.urlbar.openHistoryPopup.tooltip;" allowevents="true" inherits="open,parentfocused=focused,usertyping"></image>
