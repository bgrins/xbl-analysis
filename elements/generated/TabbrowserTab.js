class FirefoxTabbrowserTab extends FirefoxTab {
  ...
  connectedCallback() {
    ...
    this.innerHTML = `<stack class="tab-stack" flex="1">
<vbox inherits="selected=visuallyselected,fadein" class="tab-background">
<hbox inherits="selected=visuallyselected" class="tab-line">
</hbox>
<spacer flex="1">
</spacer>
...
<image inherits="fadein,pinned,busy,progress,selected=visuallyselected" class="tab-throbber" role="presentation" layer="true">
</image>
...
<toolbarbutton anonid="close-button" inherits="fadein,pinned,selected=visuallyselected" class="tab-close-button close-icon">
</toolbarbutton>
</hbox>
</stack>`;
