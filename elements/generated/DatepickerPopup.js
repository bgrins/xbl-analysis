class FirefoxDatepickerPopup extends FirefoxDatepicker {
  connectedCallback() {
    ...
    this.innerHTML = `
      <xul:hbox class="textbox-input-box datetimepicker-input-box" align="center" allowevents="true" inherits="context,disabled,readonly">
      ...
      <xul:spinbuttons anonid="buttons" inherits="disabled" allowevents="true" onup="this.parentNode._increaseOrDecrease(1);" ondown="this.parentNode._increaseOrDecrease(-1);"></xul:spinbuttons>
      <xul:dropmarker class="datepicker-dropmarker" inherits="disabled"></xul:dropmarker>
      <xul:panel onpopupshown="this.firstChild.focus();" level="top">
        <xul:datepicker anonid="grid" type="grid" class="datepicker-popupgrid" inherits="disabled,readonly,firstdayofweek"></xul:datepicker>
      </xul:panel>
    `;
