...
class MozMenuMenuBase extends MozMenuitemBase {
  connectedCallback() {
...
MozXULElement.implementCustomInterface(MozMenuMenuBase, [Ci.nsIDOMXULContainerElement]);
customElements.define("menu-menu-base", MozMenuMenuBase);
