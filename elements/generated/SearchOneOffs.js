class FirefoxSearchOneOffs extends BaseElement {
  ...
  connectedCallback() {
    ...
    this.innerHTML = `<deck anonid="search-panel-one-offs-header" selectedIndex="0" class="search-panel-header search-panel-current-input">
<firefox-text-label anonid="searchbar-oneoffheader-search" value="&searchWithHeader.label;">
</firefox-text-label>
<hbox anonid="search-panel-searchforwith" class="search-panel-current-input">
<firefox-text-label anonid="searchbar-oneoffheader-before" value="&searchFor.label;">
</firefox-text-label>
<firefox-text-label anonid="searchbar-oneoffheader-searchtext" class="search-panel-input-value" flex="1" crop="end">
</firefox-text-label>
<firefox-text-label anonid="searchbar-oneoffheader-after" flex="10000" value="&searchWith.label;">
</firefox-text-label>
</hbox>
<hbox anonid="search-panel-searchonengine" class="search-panel-current-input">
<firefox-text-label anonid="searchbar-oneoffheader-beforeengine" value="&search.label;">
</firefox-text-label>
<firefox-text-label anonid="searchbar-oneoffheader-engine" class="search-panel-input-value" flex="1" crop="end">
</firefox-text-label>
<firefox-text-label anonid="searchbar-oneoffheader-afterengine" flex="10000" value="&searchAfter.label;">
</firefox-text-label>
</hbox>
</deck>
<description anonid="search-panel-one-offs" role="group" class="search-panel-one-offs" inherits="compact">
<button anonid="search-settings-compact" oncommand="showSettings();" class="searchbar-engine-one-off-item search-setting-button-compact" tooltiptext="&changeSearchSettings.tooltip;" inherits="compact">
</button>
</description>
<vbox anonid="add-engines" class="search-add-engines">
</vbox>
<button anonid="search-settings" oncommand="showSettings();" class="search-setting-button search-panel-header" label="&changeSearchSettings.button;" inherits="compact">
</button>
<menupopup anonid="search-one-offs-context-menu">
<menuitem anonid="search-one-offs-context-open-in-new-tab" label="&searchInNewTab.label;" accesskey="&searchInNewTab.accesskey;">
</menuitem>
<menuitem anonid="search-one-offs-context-set-default" label="&searchSetAsDefault.label;" accesskey="&searchSetAsDefault.accesskey;">
</menuitem>
</menupopup>`;
