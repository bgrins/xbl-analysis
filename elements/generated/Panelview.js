  ...
  connectedCallback() {
    this.innerHTML = `
      <xul:box class="panel-header" anonid="header">
        <xul:toolbarbutton anonid="back" class="subviewbutton subviewbutton-iconic subviewbutton-back" closemenu="none" tabindex="0" tooltip="FROM-DTD-backCmd-label" oncommand="document.getBindingParent(this).panelMultiView.goBack(); this.blur()"></xul:toolbarbutton>
