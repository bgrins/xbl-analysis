class FirefoxSearchbar extends BaseElement {
  ...
  connectedCallback() {
    ...
    this.innerHTML = `<stringbundle src="chrome://browser/locale/search.properties" anonid="searchbar-stringbundle">
</stringbundle>
...
<image class="search-go-button urlbar-icon" hidden="true" anonid="search-go-button" onclick="handleSearchCommand(event);" tooltiptext="&contentSearchSubmit.tooltip;">
</image>
</hbox>
</textbox>`;
